...
class OptionsViewController: UIViewController, UITextFieldDelegate {
    ...
    func textField(textField: UITextField, shouldChangeCharactersInRange range: NSRange, replacementString string: String) -> Bool {
        ...
        case elevationText:
            let num = Int(prospectiveText)
            if num != nil {
                if (prospectiveText.characters.count <= 4 && (Int(prospectiveText) <= 9999)) {
                    return true
                } else {
                    return false
                }
        ...
        case observerYText:
            let num = Int(prospectiveText)
            if num != nil {
                if (prospectiveText.characters.count <= 4 && (Int(prospectiveText) <= 1100)) {
                    return true
                } else {
                    return false
                }
        ...
        case radiusValueLText:
            let num = Int(prospectiveText)
            if num != nil {
                if (prospectiveText.characters.count <= 4 && (Int(prospectiveText) <= 600)) {
