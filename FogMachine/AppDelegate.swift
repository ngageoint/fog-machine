...
//        let modelURL = NSBundle.mainBundle().URLForResource("fogMachineApp_iOS", withExtension: "momd")!
...
//        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("fogMachineApp_iOS.sqlite")
