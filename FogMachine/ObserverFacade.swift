...
class ObserverFacade {
    ...
    func clearEntity() {
        let request = NSFetchRequest(entityName: Fog.ENTITY)
        ...
        do {
            ...
            logError("Error clearing \(Fog.ENTITY) entity", error: error)
        }
    }
    ...
    func addObserver(observer: Observer) {
        let managedObject = NSEntityDescription.insertNewObjectForEntityForName(Fog.ENTITY, inManagedObjectContext: managedContext) as NSManagedObject
    ...
    func saveContext(managedContext: NSManagedObjectContext) {
        do {
            ...
            logError("Error saving \(Fog.ENTITY) entity", error: error)
        }
    }
    ...
    func getObservers()-> [ObserverEntity] {
        ...
        do {
            ...
            logError("Error fetching \(Fog.ENTITY) entity", error: error)
        }
        return observers
    }
