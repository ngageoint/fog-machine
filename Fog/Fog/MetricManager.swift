...
public class MetricManager {
    ...
    public func startForMetric(metric: String, deviceName: String = Worker.getMe().displayName) {
    ...
    public func stopForMetric(metric: String, deviceName: String = Worker.getMe().displayName) {
        guard let deviceMetrics = storedMetrics.getValue(deviceName) else {
            return
        }
