...
class GeoUtility {
    ...
    fileprivate static let a = 6378137.0 // WGS-84 geoidal semi-major axis of earth in meters
    fileprivate static let e: Double = 8.1819190842622e-2  // eccentricity
    fileprivate static let asq: Double = a * a
    fileprivate static let esq: Double = e * e

    fileprivate static let b: Double = sqrt(asq * (1 - esq)) // WGS-84 geoidal semi-minor axis of earth in meters

    static func degreeToRadian(_ degrees: Double) -> Double {
        return Double.pi * degrees / 180.0
    }

    static func radianToDegree(_ radians: Double) -> Double {
        return 180.0 * radians / Double.pi
    }

    // Earth radius at a given latitude in degrees, according to the WGS-84 ellipsoid in meters
    static func earthRadiusAtLat(_ lat: Double) -> Double {
    ...
    static func vincentyDistanceInMeters(_ lat1: Double, lon1: Double, lat2: Double, lon2: Double) -> Double {
    ...
    static func euclideanDistanceInMeters(_ lat1: Double, lon1: Double, lat2: Double, lon2: Double) -> Double {
    ...
    static func haversineDistanceInMeters(_ lat1: Double, lon1: Double, lat2: Double, lon2: Double) -> Double {
        let lat1rad: Double = degreeToRadian(lat1)
        let lon1rad: Double = degreeToRadian(lon1)
        let lat2rad: Double = degreeToRadian(lat2)
        let lon2rad: Double = degreeToRadian(lon2)
    ...
    static func haversineDistanceInMeters(_ lat1: Double, lon1: Double, bearingInDegrees: Double, distanceInMeters: Double) -> (Double, Double) {
